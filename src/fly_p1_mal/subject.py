...
"""Male P1 slice: DA1 slot holds hop-1 DA1 plus hop-1 mAL GABA. One shared template."""
...
from fly_p1_mal.paths import TEMPLATES
from malforge.gate import FLYWIRE_N, MALECNS_N, require_engine, require_templates
