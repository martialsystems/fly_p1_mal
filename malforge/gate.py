...
from malforge._bootstrap import ensure_paths

ensure_paths()

from graphforge.product_law import LawBlockedError, require_law

from malforge.graphs.assay_order import build_graph as build_order
from malforge.graphs.claim_bans import build_graph as build_claims
from malforge.graphs.engine_shared import N_TEMPLATES_MAX, build_graph as build_engine
from malforge.graphs.template_identity import (
    FLYWIRE_N,
    MALECNS_N,
    SLICE_N_MAX,
    build_graph as build_templates,
)
from malforge.graphs.wiring_frozen import build_graph as build_wiring
